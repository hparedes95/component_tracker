...
- **Histórico de precios a largo plazo (estilo Keepa)**: cada producto de **Amazon** muestra su gráfico de precios de **hasta 5 años** (o el máximo disponible), con selector de rango (1 / 3 / 5 años / Máx) y de proveedor (**Keepa** o **CamelCamelCamel**), para ver la tendencia real y decidir el mejor momento de compra. Un clic abre el histórico interactivo completo. Si la app no detecta sola la ficha de Amazon, basta **pegar la URL de Amazon (o el ASIN)** del producto en el propio detalle para activar el histórico y el precio al instante.
