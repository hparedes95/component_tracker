...
- **Recomendaciones y escaneo de mercado**: la app te propone componentes que **superan** a los que ya sigues, y con un botón **escanea la tienda** para descubrir novedades de tus categorías que aún no rastreas (con foto, precio y un clic para seguirlas).
- **Imágenes de producto automáticas**: cada tarjeta muestra la foto del producto, extraída de la propia web (og:image / datos estructurados) y, para Amazon, por ASIN.
- **Diseño estilo Apple**: interfaz oscura cuidada con vibrancy, tarjetas limpias, navegación fluida y comercial.
