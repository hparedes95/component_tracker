...
- **Histórico de precios a largo plazo (estilo Keepa)**: cada producto de **Amazon** muestra su gráfico de precios de **hasta 5 años** (o el máximo disponible), con selector de rango (1 / 3 / 5 años / Máx), para ver la tendencia real y decidir el mejor momento de compra. Los datos históricos provienen del gráfico público de **Keepa**; un clic abre el histórico interactivo completo.
